...
# Réplica del ejercicio realizado en clase sobre impacto de,
#desigualdad del pago en salarios sobre porcentage de juegos ganados
# en las grandes ligas de baseball

# Se toma como referencia el script de Humberto Mártinez

getwd()

#Fijamos el directorio de trabajo

setwd("C://Users/tino_/OneDrive/Documentos/Econometría/proyecto de R")
...
#la interpretación de los resultados de adjunta en markdown
