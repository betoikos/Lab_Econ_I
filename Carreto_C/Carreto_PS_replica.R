...
# R�plica del ejercicio realizado en clase sobre impacto de,
#desigualdad del pago en salarios sobre porcentage de juegos ganados
# en las grandes ligas de baseball

# Se toma como referencia el script de Humberto M�rtinez

getwd()

#Fijamos el directorio de trabajo

setwd("C://Users/tino_/OneDrive/Documentos/Econometr�a/proyecto de R")
...
#la interpretaci�n de los resultados de adjunta en markdown
