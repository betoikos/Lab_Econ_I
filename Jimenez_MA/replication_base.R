...
# Nuevamente separamos aÒos y juegos
teamwins2 <- separate(teamwins2,year_games, c("year", "games"))
head(teamwins2)

# Convertimos algunas a numÈricas
...
# Vemos estadÌsticos, top y bottom 
summary(teamwins2)
head(teamwins2)
tail(teamwins2)
